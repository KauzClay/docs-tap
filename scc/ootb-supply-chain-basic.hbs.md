...
- Building from source code:
  ...
  5. Alternatively, outputting a Carvel package containing the application to a Git repository. See [Carvel Package Supply Chains](carvel-package-supply-chain.hbs.md).
...
- Using a prebuilt application image:
  ...
  2. Alternatively, outputting a Carvel package containing the application to a Git repository. See [Carvel Package Supply Chains](carvel-package-supply-chain.hbs.md).
