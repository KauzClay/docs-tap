...
protocols on request. For more information, see the [TAP Architecture Overview](https://docs.vmware.com/en/VMware-Tanzu-Application-Platform/1.8/tap-reference-architecture/GUID-reference-designs-tap-architecture-planning.html).
